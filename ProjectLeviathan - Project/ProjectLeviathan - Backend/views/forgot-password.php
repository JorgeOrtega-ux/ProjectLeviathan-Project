            ...
            <section class="content-wrapper">
                <form id="forgot-password-form" method="POST" novalidate>
                    ...
                    <div class="register-stage disabled" id="stage-2">
                        ...
                        <div class="input-wrapper">
                            <input class="input-field" type="text" id="verification_code" name="verification_code" required placeholder=" " minlength="7" maxlength="7">
                            <label class="input-label" for="verification_code">Código de verificación*</label>
                        </div>
                        <button type="button" class="continue-btn" data-action="verify-code"><span>Continuar</span></button>
                    </div>
                ...
                <p class="other-page-link"><a href="<?php echo $BASE_URL_BACKEND; ?>login">Volver a Iniciar sesión</a></p>
            </section>
        </main>
