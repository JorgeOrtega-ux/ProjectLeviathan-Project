            ...
            <section class="content-wrapper">
                <form id="register-form" method="POST" novalidate>
                    ...
                    <div class="register-stage disabled" id="stage-3">
                        <h1>Último paso</h1>
                        <p class="verification-text">Te hemos enviado un código al número de teléfono <span id="verification-phone">(000-000-0000)</span>. Ingresa el código aquí para completar la verificación de tu cuenta.</p>
                        <div class="input-wrapper"><input class="input-field" type="text" id="verification_code" name="verification_code" required placeholder=" " minlength="7" maxlength="7"><label class="input-label" for="verification_code">Código de verificación*</label></div>
                        <button type="button" class="continue-btn" data-action="submit-verification"><span>Verificar cuenta</span></button>
                    </div>
                    <div class="error-container disabled" id="error-container"><span class="error-message" id="error-text"></span></div>
                </form>
