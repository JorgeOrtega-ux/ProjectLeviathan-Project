...
if ($action === 'get_account_dates') {
    ...
    try {
        // Establecer el idioma a español para las fechas
        ...
        // Se usa strftime para un formato localizado más fiable
...
if ($action === 'update_profile') {
    ...
    try {
        // 1. Verificar el límite de tiempo usando una lógica de segundos precisa
        ...
        if ($last_update_record) {
            ...
            $limit_seconds = 30 * 24 * 60 * 60; // 30 días en segundos
        ...
        // PREVENCIÓN DE INYECCIÓN DE SQL: Usar una consulta predefinida y segura.
        $update_query = "";
        if ($field === 'username') {
            ...
            // Si el campo no es válido, se detiene la ejecución por seguridad.
            $pdo->rollBack();
